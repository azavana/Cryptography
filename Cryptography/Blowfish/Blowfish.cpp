...
void Blowfish::Blowfish_Encipher (uint32_t *L, uint32_t *R)
{
	uint32_t Xl, Xr;
...
/* Intialize Blowfish */
void Blowfish::Blowfish_Init (uchar *key, int keybytes)
{
...
/* Crack function */
void *Blowfish::crack_text (uchar *text, uint32_t *Left, uint32_t *Right, int len_text)
{
	int block_len;
	while (len_text)
	{
